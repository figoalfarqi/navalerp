...
func NewPaymentHandler(s *service.PaymentService, c *config.Config) *PaymentHandler {
	return &PaymentHandler{Svc: s, Cfg: c}
}
...
func (h *PaymentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "payment created", item, nil)
}
...
func (h *PaymentHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "payment updated", item, nil)
}
...
func (h *PaymentHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "payment deleted", nil, nil)
}
