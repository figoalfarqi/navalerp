...
func NewWarehouseHandler(s *service.WarehouseService, c *config.Config) *WarehouseHandler {
	return &WarehouseHandler{Svc: s, Cfg: c}
}
...
func (h *WarehouseHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "warehouse created", item, nil)
}
...
func (h *WarehouseHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "warehouse updated", item, nil)
}
...
func (h *WarehouseHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "warehouse deleted", nil, nil)
}
