...
func NewQualificationHandler(s *service.QualificationService, c *config.Config) *QualificationHandler {
	return &QualificationHandler{Svc: s, Cfg: c}
}
...
func (h *QualificationHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	var req model.QualificationRequest
	...
	response.JSON(w, http.StatusCreated, "qualification created", item, nil)
}

func (h *QualificationHandler) Get(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	if id != "" {
...
func (h *QualificationHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "qualification updated", item, nil)
}
...
func (h *QualificationHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "qualification deleted", nil, nil)
}
