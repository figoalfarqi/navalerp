...
func NewShipmentHandler(s *service.ShipmentService, c *config.Config) *ShipmentHandler {
	return &ShipmentHandler{Svc: s, Cfg: c}
}
...
func (h *ShipmentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "shipment created", item, nil)
}
...
func (h *ShipmentHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "shipment updated", item, nil)
}
...
func (h *ShipmentHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "shipment deleted", nil, nil)
}
