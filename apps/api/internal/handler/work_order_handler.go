...
func NewWorkOrderHandler(s *service.WorkOrderService, c *config.Config) *WorkOrderHandler {
	return &WorkOrderHandler{Svc: s, Cfg: c}
}
...
func (h *WorkOrderHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "work_order created", item, nil)
}
...
func (h *WorkOrderHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "work_order updated", item, nil)
}
...
func (h *WorkOrderHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "work_order deleted", nil, nil)
}
