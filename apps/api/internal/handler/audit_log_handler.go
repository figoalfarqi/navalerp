...
func NewAuditLogHandler(s *service.AuditLogService, c *config.Config) *AuditLogHandler {
	return &AuditLogHandler{Svc: s, Cfg: c}
}
...
func (h *AuditLogHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "audit_log created", item, nil)
}
...
func (h *AuditLogHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "audit_log updated", item, nil)
}
...
func (h *AuditLogHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "audit_log deleted", nil, nil)
}
