...
func NewDocumentHandler(s *service.DocumentService, c *config.Config) *DocumentHandler {
	return &DocumentHandler{Svc: s, Cfg: c}
}
...
func (h *DocumentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "document created", item, nil)
}
...
func (h *DocumentHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "document updated", item, nil)
}
...
func (h *DocumentHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "document deleted", nil, nil)
}
