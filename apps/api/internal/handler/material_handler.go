...
func NewMaterialHandler(s *service.MaterialService, c *config.Config) *MaterialHandler {
	return &MaterialHandler{Svc: s, Cfg: c}
}
...
func (h *MaterialHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "material created", item, nil)
}
...
func (h *MaterialHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "material updated", item, nil)
}
...
func (h *MaterialHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "material deleted", nil, nil)
}
