...
func NewInvoiceHandler(s *service.InvoiceService, c *config.Config) *InvoiceHandler {
	return &InvoiceHandler{Svc: s, Cfg: c}
}
...
func (h *InvoiceHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusCreated, "invoice created", item, nil)
}
...
func (h *InvoiceHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "invoice updated", item, nil)
}
...
func (h *InvoiceHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	response.JSON(w, http.StatusOK, "invoice deleted", nil, nil)
}
